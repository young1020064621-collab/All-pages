...
const SDRMeetingsFilterPopup: React.FC<FiltersPopupProps> = ({
  isOpen,
  onClose,
  onApply,
  onClear,
      ...
      <div className="px-6 py-4 border-b border-gray-100 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Filter Shared Call</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-800 mb-2">Shared Date</label>
                <input
                  type="date"
                  value={filters.sharedDate}
                  onChange={(e) => onFilterChange('sharedDate', e.target.value)}
...
export default SDRMeetingsFilterPopup;