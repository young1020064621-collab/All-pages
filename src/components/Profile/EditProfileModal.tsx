...
import { X, User, Save, Mail, Phone, Building2, Briefcase, Plus, Upload, Smartphone, Linkedin, MapPin } from 'lucide-react';
...
const EditProfileModal: React.FC<EditContactPopupProps> = ({
  isOpen,
  onClose,
  contactData = {
    firstName: 'John',
