      ...
      <div className="flex items-center mb-6 pb-4 border-b border-gray-200">
        <div className="flex items-center">
          <div className="p-3 rounded-lg" style={{ backgroundColor: 'transparent' }}>
            <Map className="w-6 h-6" style={{ color: '#605BFF' }} />
          </div>
          <div className="ml-4">
            <div className="flex items-center">
              <h3 className="text-xl font-semibold text-gray-900">Buyer's Journey</h3>
            ...
            <p className="text-sm text-[#605BFF] font-medium">N.E.E.D.S.</p>
          </div>
        </div>
